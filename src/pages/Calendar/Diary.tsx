    ...
    <>
      ...
      <div className="flex flex-col w-full h-[calc(100%-200px)] px-4">
        ...
        <div className="w-full max-w-md mx-auto flex flex-col flex-1">
          ...
          <textarea
            placeholder="입력해주세요..."
            className="w-full flex-1 p-3 border border-[#D9D9D9] rounded-[10px] resize-none text-[14px] bg-white"
          />
          <div className="text-right text-[12px] text-[#999] mt-1 mb-4">
            0 / 100
          </div>

          {/* 버튼 */}
          <button className="relative w-full mb-3">
