...
export const ChatMessage = ({
  ...
  return (
    <div ref={messageRef}>
      <div
        className={`flex ${
          isMine && !msg.isBot ? "justify-end" : "justify-start"
        } mb-1`}
      >
        {isChatbot ? (
          ...
          <div className="flex flex-col items-end max-w-[70%] ml-auto">
            <span className="text-base text-gray-700 mb-1 font-GanwonEduAll_Light text-right">
              {currentNickname}
            </span>
            <div className="flex items-end gap-1 flex-row-reverse">
              <div className="px-3 py-2 rounded-xl whitespace-pre-wrap font-GanwonEduAll_Light bg-[#BD4B2C] text-[#F2F2F2] rounded-br-none">
                <span
                  className={`text-base ${
                    isHighlighted
                      ? isCurrent
